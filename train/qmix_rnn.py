...
config = {
    ...
    "EPS_DECAY": 0.1,                   # Decay steps for epsilon
    "HIDDEN_SIZE": 512,                  # Hidden size for RNN
    "MIXER_EMBEDDING_DIM": 128,          # Mixer network embedding dimension
    "MIXER_HYPERNET_HIDDEN_DIM": 256,    # Hidden layer size of hypernet
    "MIXER_INIT_SCALE": 1.0,            # Initialization scale for mixer
    "LR": 0.0003,                         # Learning rate
    "NUM_EPOCHS": 4,                    # Number of epochs per update
    "LR_LINEAR_DECAY": True,            # Whether to linearly decay LR
    ...
    "SEED": 42,                         # Random seed
    "NUM_SEEDS": 1,                     # How many seeds to run (vectorized)
    "WANDB_LOG_ALL_SEEDS": False,       # Whether to log all seeds separately
    "ALG_NAME": "qmix_rnn",             # Name of the algorithm (optional)
}
